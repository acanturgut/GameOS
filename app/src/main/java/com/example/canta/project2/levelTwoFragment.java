...
public class levelTwoFragment extends Fragment implements View.OnClickListener {
    ...
    public void onStart() {
        ...
        id223 = b[23];
        id224 = b[24];
        final int myid21,myid22,myid23,myid24,myid25;
        ...
        int t21 = flaglist.getInstance().getTarget21();
        myid21 = flagHolder.getInstance().getFlag(t21);

        int t22 = flaglist.getInstance().getTarget22();
        myid22 = flagHolder.getInstance().getFlag(t22);
        int t23 = flaglist.getInstance().getTarget23();
        myid23 = flagHolder.getInstance().getFlag(t23);
        int t24 = flaglist.getInstance().getTarget24();
        myid24 = flagHolder.getInstance().getFlag(t24);
        int t25 = flaglist.getInstance().getTarget25();
        myid25 = flagHolder.getInstance().getFlag(t25);
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                closeAll();
                tar1.setImageResource(myid21);
                tar2.setImageResource(myid22);
                tar3.setImageResource(myid23);
                tar4.setImageResource(myid24);
                tar5.setImageResource(myid25);
    ...
    public void imagesetter(final int id2, int k, int num) {
        ...
        int myid2 = flagHolder.getInstance().getFlag(ref2);
        final ImageView image1 = (ImageView) getActivity().findViewById(id2);
        image1.setImageResource(myid2);
    }
