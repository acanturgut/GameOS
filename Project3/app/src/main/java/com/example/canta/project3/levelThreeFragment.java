...
public class levelThreeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onStart() {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                retrieveImage("flag" + flaglist.getInstance().getTarget31() + ".png",R.id.target1);
                retrieveImage("flag" + flaglist.getInstance().getTarget32() + ".png",R.id.target2);
                retrieveImage("flag" + flaglist.getInstance().getTarget33() + ".png",R.id.target3);
                retrieveImage("flag" + flaglist.getInstance().getTarget34() + ".png",R.id.target8);
                retrieveImage("flag" + flaglist.getInstance().getTarget35() + ".png",R.id.target5);
                retrieveImage("flag" + flaglist.getInstance().getTarget36() + ".png",R.id.target6);
    ...
    public void imagesetter(final int id3, int k, int num) {
        ...
        String flagname = "flag" + ref3 + ".png";
        retrieveImage(flagname,id3);
    }
